# Heading Toolbar Context

## Purpose
TBD - Defines the context-sensitive behavior of the toolbar when interacting with headings, specifically disabling unsupported formatting options and managing the flow when exiting a heading block.
